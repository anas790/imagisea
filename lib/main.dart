                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: countryCode!=null ? countryCode!.flagImage
                                    : null,
                                  ),
                                  const Icon(
                                    Icons.arrow_right,
                  ...
                  style:ElevatedButton.styleFrom(
                    ...
                    onPressed: (){
                      if(countryCode!=null){
                        ...
                        ScaffoldMessenger.of(context)
                            .showSnackBar(const SnackBar(content: Text('Please select a country code')));
                      }
                        ...
                        return Container(
                          ...
                          left: 10.0,
                            ...
                            top: 50.0,
                              ...
                              const Padding(padding: EdgeInsets.only(top:25, bottom: 16.0,
                              ),
                              ),
                              ...
                              const Center(
                                child: Text(
                                  'Have not received the OTP yet? Send Again?',
                                  style: TextStyle(
                                    color: Colors.white,
